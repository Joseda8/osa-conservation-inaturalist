...
class JsonFileStorage:
    ...
    def _save_json(self, file_name: str, content: Any) -> Path:
        ...
        output_path = self._storage_dir / file_name
    ...
    def _save_json_if_enabled(self, file_name: str, content: Any, store: bool | None = None) -> Path | None:
        ...
        return self._save_json(file_name, content)
