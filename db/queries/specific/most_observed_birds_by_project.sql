-- Title: Top 25 most observed birds by project
-- Description: Shows the top 25 bird observation ranks by species for ABS and OBS. Coarser identifications remain grouped under their current taxon.
...
WITH classified_observations AS (
    ...
    WHERE observed_taxa.iconic_taxon_name = 'Aves'
),
taxon_counts AS (
    SELECT
        project_alias,
