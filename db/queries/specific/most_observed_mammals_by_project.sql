-- Title: Top 25 most observed mammals by project
-- Description: Shows the top 25 mammal observation ranks by species for ABS and OBS. Coarser identifications remain grouped under their current taxon.
...
WITH classified_observations AS (
    ...
    WHERE observed_taxa.iconic_taxon_name = 'Mammalia'
),
taxon_counts AS (
    SELECT
        project_alias,
