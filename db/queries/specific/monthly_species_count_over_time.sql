...
-- Description: Shows how a selected species observation count changes by month and region. Bind period_start to trends.period_start, species to trends.dimension_label, and region_key to trends.region_key.
