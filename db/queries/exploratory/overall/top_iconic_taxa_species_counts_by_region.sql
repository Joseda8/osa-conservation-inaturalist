...
-- Description: Shows the top iconic taxa by summed monthly species count for a selected observed-date timespan. Configure period_start as a Metabase Field Filter mapped to trends.period_start, region_key as a Metabase Field Filter mapped to trends.region_key, and top_n as an optional Number variable.
