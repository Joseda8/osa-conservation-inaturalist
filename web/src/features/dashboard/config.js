...
export const OSA_STATS_REPORTS = [
  ...
  { fileName: "abs-vs-obs-quality-grades.csv", id: "quality-grades", label: "Quality grades", sectionId: "osa-stats", visualization: { annotationColumn: "project_observation_percentage", ariaLabel: "Grouped bar chart comparing ABS and OBS observations by quality grade", categoryColumn: "quality_grade", categoryLabels: { casual: "Casual", needs_id: "Needs ID", research: "Research grade" }, seriesColumn: "project_alias", seriesLabels: { abs: "ABS", obs: "OBS" }, totalColumn: "project_total_observation_count", totalLabel: "Total observations", totalObservationColumn: "total_observation_count", type: "grouped-bar", valueColumn: "observation_count", valueLabel: "observations" } },
];
