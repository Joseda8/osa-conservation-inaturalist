...
export const OSA_STATS_REPORTS = [
  ...
  { fileName: "abs-vs-obs-quality-grades.csv", id: "quality-grades", label: "Quality grades", sectionId: "osa-stats", visualization: { annotationColumn: "project_observation_percentage", ariaLabel: "Grouped bar chart comparing ABS, OBS, and all OSA projects by quality grade", categoryColumn: "quality_grade", categoryLabels: { casual: "Casual", needs_id: "Needs ID", research: "Research grade" }, hiddenTotalSeries: ["aggregated"], seriesColumn: "project_alias", seriesLabels: { abs: "ABS", aggregated: "All projects", obs: "OBS" }, seriesOrder: ["abs", "obs", "aggregated"], totalColumn: "project_total_observation_count", totalLabel: "Total observations", totalObservationColumn: "total_observation_count", totalSeriesId: "aggregated", type: "grouped-bar", valueColumn: "observation_count", valueLabel: "observations" } },
  { fileName: "abs-vs-obs-species-reported-by-month.csv", id: "species-reported-over-time", label: "Species reported over time", sectionId: "osa-stats", visualization: { ariaLabel: "Monthly species reported by ABS, OBS, and all OSA projects", dateColumn: "period_start", defaultGrouping: "month", defaultRangePreset: "last-90", seriesColumn: "project_alias", seriesLabels: { abs: "ABS", aggregated: "All projects", obs: "OBS" }, seriesOrder: ["abs", "obs", "aggregated"], type: "time-series", valueColumn: "species_count", valueLabel: "species" } },
];
